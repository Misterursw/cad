...
# Count and print parameters after defining trainable layers
...
def main(rank, opts) -> str:
    ...
    total_params, trainable_params = count_model_params(sam)
    if opts.rank == 0:  # Only print on the main process
...
if __name__ == '__main__': 
    ...
    if opts.dist:
        ...
        #opts.num_workers = opts.ngpus_per_node 
        opts.num_workers =0
